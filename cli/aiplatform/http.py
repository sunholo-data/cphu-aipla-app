...
_DEFAULT_URLS = {
    ...
    "dev": "https://aitana-v6-backend-66pa3y5xnq-ew.a.run.app",
    "test": "https://aitana-v6-backend-test-placeholder.a.run.app",
    "prod": "https://aitana-v6-backend-prod-placeholder.a.run.app",
}

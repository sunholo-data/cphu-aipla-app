...
export default function ProjectOverviewPage() {
  return (
    <main>
      <section className="border-b border-border bg-gradient-to-br from-brand/90 via-brand to-brand/80 text-white">
        <div className="px-6 py-16 sm:px-10 sm:py-20 lg:px-14">
          <p className="text-sm font-medium uppercase tracking-[0.18em] text-brand-foreground/80">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-brand-foreground/90 sm:text-xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/project/about" className="inline-flex items-center gap-2 rounded-md bg-white px-4 py-2.5 font-medium text-brand hover:bg-brand-tint">
      ...
      <section className="px-6 py-12 sm:px-10 lg:px-14">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.16em] text-brand">The project</p>
        ...
        <ul className="mt-10 grid gap-4 sm:grid-cols-2">
          {PROJECT_PAGES.map((page) => {
            ...
            return (
              <li key={page.slug}>
                <Link href={`/project/${page.slug}`} className="group flex h-full flex-col rounded-xl border border-border bg-background p-6 transition hover:-translate-y-0.5 hover:border-brand-line hover:shadow-md">

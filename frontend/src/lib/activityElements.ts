...
// any workbench type — checklist today; data table / chart / calculator /
// document land as 1.1.38 M1–M4. Adding an element = a kind here + a backend
...
export type ElementKind = "checklist";

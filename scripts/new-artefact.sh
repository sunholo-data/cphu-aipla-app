...
echo "     The <!-- @aipla-bridge --> block is the SHARED guest bridge"
echo "     (speaks the AIPLA app + ChatGPT) — do NOT hand-edit it. To change"
echo "     transport, edit infrastructure/mcp-sandbox/bridge/aipla-mcp-bridge.js"
echo "     then 'make sim-build' (CI's sim-bridge job fails on drift)."

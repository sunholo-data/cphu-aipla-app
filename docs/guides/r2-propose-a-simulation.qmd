...
subtitle: "AIPLA researcher guide — R2"
---
...
**Use an AI chat, and paste the authoring prompt.** It lives at
`.claude/skills/mcp-app-artefact/resources/authoring-prompt.md` in the app
repository — ask M or AD to send it to you. It tells the AI the size limit, the
...
| For | Ask |
|---|---|
| Getting the authoring prompt, or handing over a draft | M or AD |

...
- Scoping site **Strand C** ([`strands.qmd`](https://aipla.ku.dk/project/workstreams)) — the pedagogical/research source of truth (C3 student models, the resources framework, the social-network research design).

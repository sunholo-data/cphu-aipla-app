...
- Scoping site [architecture.qmd ADR-001](../_scoping-snapshot/architecture.qmd#adr-001-student-identity-no-auth-anonymous-group-ids) — the anonymous-group design this tooling implements ops for

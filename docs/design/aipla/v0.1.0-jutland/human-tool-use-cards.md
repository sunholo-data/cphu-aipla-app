...
- [ADR-013](file:///Users/mark/Documents/clients/cph-uni/architecture.qmd#adr-013-artefact-safety-content-review-pipeline-for-generated-html) — sandbox iframe constraints (cards are host-side so unaffected, but the events they reflect come from sandboxed surfaces)
- [ADR-015](file:///Users/mark/Documents/clients/cph-uni/architecture.qmd#adr-015-unified-multi-surface-ui-ai-directs-the-layout) — multi-surface UI; cards are the `chat`-surface mirror of `workspace`-surface actions

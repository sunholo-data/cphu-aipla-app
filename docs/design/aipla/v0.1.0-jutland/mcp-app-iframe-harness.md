...
- ADR-013's "Consequences" section in [architecture.qmd](../_scoping-snapshot/architecture.qmd#adr-013-artefact-safety-content-review-pipeline-for-generated-html) gains a sub-bullet documenting "Authentication: window-identity not origin" with a one-line rationale.
...
- [ADR-013](../_scoping-snapshot/architecture.qmd#adr-013-artefact-safety-content-review-pipeline-for-generated-html) — sandbox + CSP decision this design completes

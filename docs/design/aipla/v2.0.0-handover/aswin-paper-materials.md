...
| **Khanmigo** (Khan Academy) | Socratic-style AI tutor/teaching assistant across maths, science, history, CS, language arts; free for US K-12 | Broad-subject, chat-first; no workbench/simulation coupling comparable to AIPLA's — the tutor sees what the student *typed*, not a shared workspace state |

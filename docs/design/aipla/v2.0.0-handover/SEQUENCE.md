...
> [timeline.qmd](https://aipla.ku.dk/project/progress)); this is execution.
...
| 3.2 | [self-hosting-and-terraform-handover.md](self-hosting-and-terraform-handover.md) | UCPH on-prem **resource list**, hybrid topologies, ADR-003-tier model sizing, and a portable two-layer Terraform deliverable. The costable "what IT needs to host this" artefact. | 003, 005, 006, 007, 010, 012, 017 | 2d (audit, contracted) + 3–4d (reference stack, stretch) | **Contracted bar met** — Phase 0 + Firestore slice of Phase 1 done (opened 2026-06-17); Phase 2 (reference Terraform/Helm) stretch, not started |
...
| 3.6 | [strand-c-scoping-note.qmd](strand-c-scoping-note.qmd) | **The contracted Strand C deliverable** — C1 beyond LLMs, C2 beyond chat, C3 student models, with recommendations and effort. Written as **findings, not proposals**: all three directions were partly built during the contract, so it reports what happened. | 003 | ~1d (done) | **DRAFTED 2026-09-02** — the last outstanding contracted item, due 09-09 |
| 3.7 | [aswin-paper-materials.md](aswin-paper-materials.md) | Everything to hand Aswin for the *Applied Artificial Intelligence* overview paper (item 22/35 of the 09-01 triage): pointers to existing public material, a differences-from-existing-tools comparison, and example teacher/student flow walkthroughs. | — | ~1.5d | **Complete 2026-09-09** |

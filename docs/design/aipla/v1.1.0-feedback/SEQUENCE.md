...
| 1.1.19 | teacher-activity-authoring | **OPEN** | design-only (2026-06-08). Umbrella for non-sim teacher activity creation; aggressive v1.1, phased (M0 ~1.5d pre-freeze). M2 quiz / M4 workbench-type gated on JB/AR |

**Tally: 9 SHIPPED · 1 PARTIAL · 8 OPEN.**
...
2. 1.1.7 multimodal upload — JB image-retention posture
...
- **1.1.19 teacher-activity-authoring M0** — no-workbench concept activity, end-to-end (~1.5d, lands pre-freeze; the 3-June headline ask)

...
| 1.1.25 | curriculum-library | **OPEN** | design-only (2026-06-09). Hard prerequisite 1.3 pgvector; JB/M copyright clearance for shared corpus |

**Tally (incl. 9 June batch): 9 SHIPPED · 1 PARTIAL · 15 OPEN.** (6 OPEN rows added 2026-06-09 — all design/brief-only.)

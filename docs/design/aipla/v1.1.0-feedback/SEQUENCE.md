...
| 1.1.6 | [group-code-school-year-ttl.md](group-code-school-year-ttl.md) — sprint: [quick-wins-v1.1-sprint.md](quick-wins-v1.1-sprint.md) (Track B) | P1 | ~2h | [session-persistence.md](../v1.0.0-pilot/implemented/session-persistence.md) (1.F shipped) | Extend default group-code + session TTL from 30d to 300d (~Danish school year). Soft archival on expiry (BQ chat/workbench rows retained; Firestore doc flagged `archived: true`). Prerequisite for the portfolio-download feature (deferred to year-end) |

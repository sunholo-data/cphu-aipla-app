...
| 13 | Several instances of one element (two tables) | **TUTOR HALF SHIPPED 2026-08-31**; builder half open | [multi-table-activities.md](multi-table-activities.md) (1.1.71), designed 2026-08-10, deferred during pilot week for id-migration risk. **Third independent request** (Aswin 10 Aug · 25 Aug notes · this teacher). Shares a root cause with item 26. |

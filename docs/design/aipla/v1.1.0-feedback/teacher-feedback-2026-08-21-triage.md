...
| 17 | Asterisk as a multiplication sign | **SHIPPED 2026-08-27** | `skills/preambles/math_notation.md` + `adk/math_notation.py`, injected **unconditionally** into every skill's prompt — a house style with no flag to forget. Takes effect on the next seed. |

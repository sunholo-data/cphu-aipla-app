...
**Status:** M0 (registry) + M1 (data table) + M2 (chart) + M3 (calculator) **SHIPPED 2026-06-22**, end-to-end; M4–M5 planned (P1, v1.1 — phased; each element an independent thin probe)

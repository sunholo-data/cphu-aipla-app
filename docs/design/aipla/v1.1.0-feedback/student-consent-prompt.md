...
- ADR-001 (anonymous group auth — unchanged by this doc) — in the [scoping site](../_scoping-snapshot/architecture.qmd)
- ADR-005 (chat log storage) — in the [scoping site](../_scoping-snapshot/architecture.qmd)

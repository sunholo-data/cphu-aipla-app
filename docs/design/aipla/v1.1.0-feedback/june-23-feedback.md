...
| QDrant RAG; "questions matched with what the student is looking at" | Mixed (mostly shipped) | Context-awareness = workbench **trust-cards SHIPPED**. (QDrant is a raw idea; the actual store is **Vertex AI RAG Engine** — [ADR-017](file:///Users/mark/Documents/clients/cph-uni/architecture.qmd).) |

...
**Source brief:** [`june-03-feedback-sprint-brief.md`](../_scoping-snapshot/prototypes/june-03-feedback-sprint-brief.md) + [`june-09-feedback-sprint-brief.md` §A](../_scoping-snapshot/prototypes/june-09-feedback-sprint-brief.md) (curriculum library + equipment co-design) + `notes/2026-06-15-teacher-feedback.md` (private scoping-site file, not published) (15 June: teacher chooses RAG inputs) + scoping-site [`strands.qmd`](https://aipla.ku.dk/project/workstreams) "Teacher activity creation and branching"
